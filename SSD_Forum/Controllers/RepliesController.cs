...
namespace SSD_Forum.Controllers
{
    public class RepliesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReplyId,Content,UserWhoReplied,DateReplied")] Reply reply)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReplyId,Content,UserWhoReplied,DateReplied")] Reply reply)
        {
            if (id != reply.ReplyId)
            {
                return NotFound();
